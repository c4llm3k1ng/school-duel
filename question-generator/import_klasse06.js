'use strict';
// Einmalig-Skript: importiert alle 25 klasse06_block*.json Dateien nach Firebase
// Pfad-Schema: questionBank/<subject>/<subcategory>/klasse6
...
const BLOCK_MAP = {
  'block01_mathe_zahlen':        ['Mathematik',      'Zahlen',           '6'],
  'block02_mathe_brueche':       ['Mathematik',      'Brüche',           '6'],
  'block03_mathe_geo':           ['Mathematik',      'Geometrie',        '6'],
  'block04_mathe_kopfrechnen':   ['Mathematik',      'Kopfrechnen',      '6'],
  'block05_deutsch_grammatik':   ['Deutsch',         'Grammatik',        '6'],
  'block06_deutsch_rechtschreibung': ['Deutsch',     'Rechtschreibung',  '6'],
  'block07_deutsch_wortarten':   ['Deutsch',         'Grammatik',        '6'],
  'block08_deutsch_texte':       ['Deutsch',         'Literatur',        '6'],
  'block09_englisch_vocab':      ['Englisch',        'Vokabular',        '6'],
  'block10_englisch_grammatik':  ['Englisch',        'Grammatik',        '6'],
  'block11_englisch_zeitformen': ['Englisch',        'Grammatik',        '6'],
  'block12_geschichte_antike':   ['Geschichte',      'Antike',           '6'],
  'block13_geschichte_mittelalter': ['Geschichte',   'Mittelalter',      '6'],
  'block14_bio_allgemein':       ['Biologie',        'Allgemein',        '6'],
  'block15_bio_koerper':         ['Biologie',        'Körper & Gesundheit', '6'],
  'block16_bio_botanik':         ['Biologie',        'Botanik',          '6'],
  'block17_erdkunde_europa':     ['Allgemeinwissen', 'Geographie',       '6'],
  'block18_erdkunde_welt':       ['Allgemeinwissen', 'Geographie',       '6'],
  'block19_physik_allgemein':    ['Physik',          'Mechanik',         '6'],
  'block20_aw_natur':            ['Allgemeinwissen', 'Natur & Tiere',    '6'],
  'block21_aw_musik_kunst':      ['Allgemeinwissen', 'Musik & Kunst',    '6'],
  'block22_aw_sport':            ['Allgemeinwissen', 'Sport',            '6'],
  'block23_aw_technik':          ['Allgemeinwissen', 'Technik',          '6'],
  'block24_aw_essen_kultur':     ['Allgemeinwissen', 'Essen & Kultur',   '6'],
  'block25_aw_gemischt':         ['Allgemeinwissen', 'Allgemein',        '6'],
};
